...
We can now perform some multivariate outlier detection algorithms, for detecting and removing outliers in the multivariate space.
...
deposit_yes <- data_dummy[which(data_dummy$y == 1), ]  # all yes's of outcome class
deposit_no <- data_dummy[which(data_dummy$y ==  0), ]  # all no's of outcome class
